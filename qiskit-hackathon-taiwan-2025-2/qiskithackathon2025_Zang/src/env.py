...
class VQEnv(gym.Env):
    ...
    def __init__(self,
        ...
        self.gate_types = ['h', 'x', 'y', 'z', 'cx', 'cz', 'rx', 'ry', 'rz', 't', 's', 'sx']
    ...
    def compute_reward(self, current_energy: float, circuit: QuantumCircuit) -> float:
        ...
        # Reward components
        accuracy_reward = -energy_diff * 1000000  # Scale energy difference
        complexity_penalty = 0.01 * (cnot_count + depth + gate_count)
